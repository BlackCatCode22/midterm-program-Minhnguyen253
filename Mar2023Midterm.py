...
# Open the input file
my_file = open("C:/myMidterm01/midterm-program-Minhnguyen253/animalNames.txt", "r", encoding="utf-8")
...
my_file = open("C:/myMidterm01/midterm-program-Minhnguyen253/arrivingAnimals.txt", "r", encoding="utf-8")
